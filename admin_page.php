...
<div class="container">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="change_location.php" style="color: black;">Change location</a>
        </li>
        <li class="nav-item">
...
<td class="tl-4"><?php echo $rows['name']; ?> <?php echo $rows['name']; ?></td>
</tr>
