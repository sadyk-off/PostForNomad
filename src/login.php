...
<body>
    <div class="d-flex justify-content-center align-items-center login-container">
        <form class="login-form text-center" action="login_test.php" method="post">
            ...
            <p class="mt-3 font-weight-normal">Don't have an account? <a href="Reg.html"><strong>Register Now</strong></a></p>
        </form>
    </div>
